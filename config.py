...
BOT_USERNAME = getenv("BOT_USERNAME", "shreyus_music_bot")
BOT_NAME = getenv("BOT_NAME", "shreyus")
ASSUSERNAME = getenv("ASSUSERNAME", "SHREYU_XD")
...
LOGGER_ID = int(getenv("LOGGER_ID", -1003676062396))
...
# Git
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Ankit0085d/STRANGER-MUSIC")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN", None)

# Support
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/shreyus_updates")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/stakes_xd")
...
START_IMG_URL = getenv("START_IMG_URL", "https://files.catbox.moe/yn11hf.jpg")
PING_IMG_URL = getenv("PING_IMG_URL", "https://files.catbox.moe/pltowg.jpg")
...
SHASHANK_IMG = [
    "https://files.catbox.moe/ut9gjq.jpg",
    "https://files.catbox.moe/29u5kz.jpg",
    "https://files.catbox.moe/yn11hf.jpg",
    "https://files.catbox.moe/6borug.jpg",
    "https://files.catbox.moe/v78vpg.jpg",
    "https://files.catbox.moe/314oxa.jpg",
    "https://files.catbox.moe/yn11hf.jpg"
]
